...
class ExportReport:
    ...
    def generate_pdf(self, out_dir: str) -> str:
        ...
        body_sty = sty("BD",  fontSize=9.5, textColor=colors.HexColor("#d1e8d1"),
        ...
        bullet_sty  = sty("BUL", fontSize=9.5, textColor=colors.HexColor("#d1e8d1"),
        ...
        quote_sty   = sty("QT",  fontSize=9,  textColor=C_TEA, leading=13,
                           ...
                           backColor=colors.HexColor("#061e35"), spaceAfter=8,
                           spaceBefore=4)
        ...
        def tbl_style_base(header_bg=C_TEAL, alt1=C_INK2, alt2=C_INK3):
            return TableStyle([
                ...
                ("TEXTCOLOR",     (0,1), (-1,-1), C_MINT),
                ("ROWBACKGROUNDS",(0,1), (-1,-1), [alt1, alt2]),
                ("GRID",          (0,0), (-1,-1), 0.3, colors.HexColor("#238689")),
        ...
        def ax_style(ax, title="", xlabel="", ylabel=""):
            ...
            ax.grid(True, color="#238689", alpha=0.25, linewidth=0.5)
